        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex items-center space-x-4 mb-8">
              ...
              />
              <span className="text-coffee-yellow font-bold tracking-[0.4em] uppercase text-xs">{t('about.hero.subtitle')}</span>
            </div>
            
            <h1 className="text-5xl md:text-8xl font-serif text-coffee-cream mb-8 leading-[1.1]">
              {t('about.hero.title').split(t('about.hero.titleItalic'))[0]}
              <span className="text-coffee-yellow italic">{t('about.hero.titleItalic')}</span>
              {t('about.hero.title').split(t('about.hero.titleItalic'))[1]}
            </h1>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-serif text-coffee-petrol mb-10 leading-tight">
                {t('about.story.title').split(t('about.story.titleItalic'))[0]}
                <span className="text-coffee-gold italic">{t('about.story.titleItalic')}</span>
                {t('about.story.title').split(t('about.story.titleItalic'))[1]}
              </h2>
              ...
              <div className="mt-12 flex items-center space-x-8">
                <div>
                  ...
                  <span className="text-[10px] uppercase tracking-widest text-coffee-gold font-bold">{t('about.story.est')}</span>
                </div>
                <div className="w-[1px] h-10 bg-coffee-blue/10" />
                <div>
                  <span className="block text-3xl font-serif text-coffee-petrol">100%</span>
                  <span className="text-[10px] uppercase tracking-widest text-coffee-gold font-bold">{t('about.story.grade')}</span>
                </div>
              </div>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-24">
              <div className="flex items-center justify-center space-x-3 mb-4">
                <div className="w-1.5 h-1.5 rounded-full bg-coffee-yellow" />
                <span className="text-[10px] font-bold text-coffee-gold uppercase tracking-[0.3em]">{t('about.philosophy.label')}</span>
                <div className="w-1.5 h-1.5 rounded-full bg-coffee-yellow" />
              </div>
            ...
            <div className="relative px-4 md:px-0">
              ...
              <div className="grid md:grid-cols-4 gap-10 md:gap-8">
                {t('about.philosophy.steps').map((step: any, i: number) => (
                  <motion.div 
                    key={i}
