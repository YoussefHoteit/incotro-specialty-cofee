        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-coffee-yellow/80 backdrop-blur-md text-coffee-petrol px-6 py-3 rounded-full font-bold text-base hover:bg-coffee-yellow transition-all flex items-center justify-center group border border-white/20">
                View Menu
